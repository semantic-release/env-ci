...
test("PR 1.0", async (t) => {
  ...
  t.deepEqual(
    semaphore.configuration({
      env: { ...env1, PULL_REQUEST_NUMBER: "10", BRANCH_NAME: "pr-branch" },
      cwd,
    }),
    {
      name: "Semaphore",
...
test("Push 2.0", (t) => {
  t.deepEqual(
    semaphore.configuration({
      env: { ...env2, SEMAPHORE_GIT_TAG_NAME: "v1.0.0" },
    }),
    {
      name: "Semaphore",
      service: "semaphore",
...
test("PR 2.0", (t) => {
  t.deepEqual(
    semaphore.configuration({
      env: {
        ...env2,
        SEMAPHORE_GIT_PR_NUMBER: "10",
        SEMAPHORE_GIT_PR_BRANCH: "pr-branch",
      },
    }),
    {
      name: "Semaphore",

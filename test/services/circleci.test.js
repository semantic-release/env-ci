...
test("PR 1.0", (t) => {
  t.deepEqual(
    circleci.configuration({
      env: { ...env, CIRCLE_BRANCH: "pr-branch", CI_PULL_REQUEST: "uri/pr/10" },
    }),
    {
      name: "CircleCI",
      service: "circleci",
...
test("PR 2.0", (t) => {
  t.deepEqual(
    circleci.configuration({
      env: {
        ...env,
        CIRCLE_BRANCH: "pr-branch",
        CIRCLE_PULL_REQUEST: "uri/pr/10",
      },
    }),
    {
      name: "CircleCI",
...
test("PR 2.0 without pull uri", (t) => {
  t.deepEqual(
    circleci.configuration({
      env: { ...env, CIRCLE_BRANCH: "pr-branch", CIRCLE_PR_NUMBER: "10" },
    }),
    {
      name: "CircleCI",
      service: "circleci",
